  ...
  return (
        ...
        <div className="absolute top-0 right-0 text-right z-20">
          <div className="flex items-start">
            ...
            <div className="flex flex-col items-end">
              <h2 
                className="text-[15px] sm:text-[20px] md:text-[30px] lg:text-[40px] xl:text-[50px] text-dark font-english font-bold bg-[#EEEEEE] tracking-tight px-4 py-0 inverted-corner-top-right z-10 tracking-wider"
              >
                Monthly Pickup Playlist
              </h2>
              
              <div className="text-[10px] sm:text-[12px] md:text-[15px] lg:text-[18px] xl:text-[20px] font-english font-bold text-primary font-bold bg-[#EEEEEE] px-4 py-0 inverted-corner-top-right">yukue Records</div>
            </div>
            
            {/* 日本語テキスト（右側） */}
            <div className="flex flex-col items-center bg-[#EEEEEE] px-7 pb-10 pt-5 rounded-r inverted-corner-top-right-bold z-10">
              <h1 
    ...
    <div className="w-[min(1400px,calc(100vw-2rem))] mx-auto mt-4 flex items-center gap-4 justify-center">
      ...
      <Link href="/archive">
        ...
        >
          <div className="flex items-center justify-center relative z-10">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 -960 960 960" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'translateX(-4px)' }}>
